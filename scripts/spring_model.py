...
def pred_unet(model, image):
    ...
    test_salobj_dataset = salob(image, transform=transforms.Compose([
    ...
    for i_test, data_test in enumerate(test_salobj_dataloader):
        ...
        imask = np.array(mask.resize(
            (image.shape[1], image.shape[0]), resample=Img.BILINEAR))
...
def main_springs(image):
    model_dir = "/home/poop/u2netp.pth"
    net = U2NETP(3, 1)
