...
model=load_model(checkpoint_path='/home/rishabh/frinks/tata_comms/tata_demo/10_model.pth',device='cpu')
    ...
    for old_key,old_value in bboxcoords.items():
        ...
        if old_key=='rivet_top':
            ...
            for key,coord in old_value.items():
                ...
                image=predict(model,image,device='cpu')
